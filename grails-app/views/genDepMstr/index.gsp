     ...
     //shrinkToFit: true,
        ...
        controller: {
            loadData: function(filter) {
                ...
                $.ajax({
                    url: "${createLink(action: 'GetList', controller:'GenDepMstr')}",
        ...
        fields: [
             // { name: "id", type: "text",title: "Department ID", width: 100 },
              { name: "depCd", type: "text",title: "Department Code", width: 100 },
             { name: "depName", type: "text",title: "Department Name",width: 100},
...
//                alert  ( "here "+ (id) );
                ...
                window.location = '${createLink(controller:"GenDepMstr",action:"edit",id:"")}'+(args.item.id);
                },
       ...
       <g:link class="btn btn-primary save"controller="GenDepMstr"  action="create">Create</g:link>
  </body>
