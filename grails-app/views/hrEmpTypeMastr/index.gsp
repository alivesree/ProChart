     ...
     //shrinkToFit: true,
        ...
        controller: {
            loadData: function(filter) {
                ...
                $.ajax({
                    url: "${createLink(action: 'GetList', controller:'HrEmpTypeMastr')}",
        ...
        fields: [
             // { name: "id", type: "text",title: "Department ID", width: 100 },
              { name: "empTypeName", type: "text",title: "Employee Type Code", width: 100 },
             { name: "empTypeDesc", type: "text",title: "Employee Type Name",width: 100},
...
//                alert  ( "here "+ (id) );
                ...
                window.location = '${createLink(controller:"HrEmpTypeMastr",action:"edit",id:"")}'+(args.item.id);
                },
       ...
       <g:link class="btn btn-primary save"controller="HrEmpTypeMastr"  action="create">Create</g:link>
  </body>
