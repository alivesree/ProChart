...
<html>
  ...
  <body>
        ...
        //shrinkToFit: true,
           ...
           controller: {
               loadData: function(filter) {
                   ...
                   $.ajax({
                       url: "${createLink(action: 'GetList', controller:'ProChannelMastr')}",
           ...
           fields: [
                // { name: "id", type: "text",title: "Department ID", width: 100 },
                 { name: "chnlName", type: "text",title: "Channel Name", width: 100 },                        
   ...
   //                alert  ( "here "+ (id) );
                   window.location = '${createLink(controller:"ProChannelMastr",action:"edit",id:"")}'+(args.item.id);
           },
  ...
  <g:link class="btn btn-primary save"controller="ProChannelMastr"  action="create">Create</g:link>
</body>
